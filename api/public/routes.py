...
def api_productos():
    ...
    cur.execute("SELECT id, nombre, stock, precio, image_url, rating FROM productos")
...
@public_bp.route('/registro', methods=['POST'])
def api_registro():
...
@public_bp.route('/productos/categorias/<categoria>', methods=['GET'])
